...
impl GuiUpperNotebook {
    ...
    pub fn update_language(&self) {
        self.check_button_recursive.set_label(Some(&fl!("upper_recursive_button")));
        ...
        // ] {
        //     self.notebook_upper.tab_label(&vec_children[upper_enum]).unwrap().downcast::<gtk4::Label>().unwrap().set_text(&fl_thing);
        // }
    }
}
